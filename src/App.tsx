  ...
  const QuoteModal = () => {
    ...
    return (
      <Dialog open={showQuoteModal} onOpenChange={setShowQuoteModal}>
        <DialogContent className="sm:max-w-[500px] bg-slate-900 border-slate-700 text-white" onInteractOutside={(e) => e.preventDefault()}>
          <DialogHeader>
          ...
          <Tabs value={`step${quoteStep}`} className="w-full">
            ...
            <TabsContent value="step2" className="space-y-4 mt-0">
              <div className="space-y-2">
                <Label htmlFor="peso" className="text-white">Peso aproximado (kg)</Label>
                <Input
                  id="peso"
                  type="number"
                  placeholder="Ex: 50"
              ...
              <div className="space-y-2">
                <Label htmlFor="tipo" className="text-white">Tipo de carga</Label>
                <Select value={formData.tipo} onValueChange={(value) => setFormData({...formData, tipo: value})}>
                  <SelectTrigger className="bg-slate-800 border-slate-700 text-white">
                    <SelectValue placeholder="Selecione o tipo" className="text-white" />
                  </SelectTrigger>
                  <SelectContent className="bg-slate-800 border-slate-700 text-white">
                    <SelectItem value="geral" className="text-white">Carga Geral</SelectItem>
                    <SelectItem value="refrigerada" className="text-white">Refrigerada</SelectItem>
                    <SelectItem value="perigosa" className="text-white">Perigosa</SelectItem>
                    <SelectItem value="fragil" className="text-white">Frágil</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </TabsContent>
